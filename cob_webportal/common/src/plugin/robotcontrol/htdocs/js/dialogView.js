var LoadingDialogView = function(title, msg) {
	...
	this.create = function(id) {
		...
		this.container.html('<img src="chrome/htdocs/images/ajax-loader-trans.gif" class="loader"/><p class="msg">' + this.msg + '</p><ul></ul>');
...
var WaitDialogView = function() {
	...
	this.create = function(id) {
		...
		this.container.addClass('dialogView');
		this.container.addClass('loadingDialogView');
		this.container.html('<img style="padding:10px 0 0 60px;" src="chrome/htdocs/images/ajax-loader-trans.gif" class="loader"/>');
		this.ul = this.container.find('ul'); 
	}
	this.destroy = function() {
		this.container.remove();
...
var ServerPreparesReservation = function() {
	...
	this.container.addClass('dialogView');
	this.container.addClass('loadingDialogView');
	this.container.html('<img src="chrome/htdocs/images/ajax-loader-trans.gif" class="loader"/><p class="msg">The Server prepares your reservation. Please wait this might take a minute. <b>You\'ll be redirected automatically.</b></p>');
	this.ul = this.container.find('ul'); 
    }
    this.destroy = function() {
	this.container.remove();
